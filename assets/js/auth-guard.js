...
// Firebase puede quedar congelado. Forzamos una recarga real.
window.addEventListener("pageshow", (event) => {
  if (event.persisted) location.reload();
});

// authStateReady() espera a que Firebase termine de confirmar si hay una
// sesión guardada antes de decidir nada. Sin esto, a veces "onAuthStateChanged"
// avisa primero (por una fracción de segundo) que no hay nadie logeado,
// aunque sí lo esté, y el sitio alcanza a redirigir a login por error.
